          ...
          <div className="flex items-start space-x-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                {user && user.user_id === profile.seller.user_id && (
                  <button
                    onClick={() => router.push('/profile/edit/')}
                    className="ml-auto px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors flex items-center gap-2"
                  >
